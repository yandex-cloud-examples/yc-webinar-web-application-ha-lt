...
variable "security_groups_ids_master" {
...
variable "security_groups_ids_nodes" {
  description = "List of security group IDs to which the nodes of kubernetes cluster belongs"
  type        = list(string)
  default     = []
  nullable    = true
}
