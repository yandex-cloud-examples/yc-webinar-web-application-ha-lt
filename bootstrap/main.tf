...
locals {
  ...
  network_id         = var.network_id == null ? module.network.network_id : var.network_id
  ...
  subnets = [
    {
      ...
      "route_table" : "gitlab-runner-inet-access"
    }
  ]
  route_tables = [
    {
      "name" : "gitlab-runner-inet-access",
      "routes" : [
        {
